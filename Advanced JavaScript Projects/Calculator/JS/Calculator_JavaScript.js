...
//This moifies values each time a button is clicked on.
...
function Handle_Operator(Next_Operator) {
    ...
    //Caculator.First_Operand if it doesn't already exist
...
keys.addEventListener('click', (event) => {
    ...
    //Ensures that AC clears all inmputs from the Calculator screen.
